...
/**
 * Login component for passwordless authentication
 * Allows users to request a sign-in link via email
 */
export default function Login() {
   ...
   */
  async function sendLink(e: React.FormEvent<HTMLFormElement>): Promise<void> {
    e.preventDefault();
    ...
    try {
      await authApi.requestPasswordless(email.trim());
      setStatus('sent');
      setMessage('Check your email for the passwordless sign-in link.');
    } catch (error) {
      setStatus('error');
      const errorMessage = error instanceof Error ? error.message : 'Error sending authentication link';
